...
const Home = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setIsLoading(false);
      // Aguarda um pouco para permitir a animação de fade-out
      setTimeout(() => {
        setShowContent(true);
      }, 100);
    }, 2000);
  ...
  return (
    <>
      ...
      {showContent && (
        <LayoutConfig>
          <div className="content-screen relative overflow-hidden w-screen sm:w-[440px] bg-yellow-dudaris min-h-[762px] rounded-xl flex justify-center px-5">
            ...
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="flex flex-col items-center gap-4">
                <h2 className="font-semibold text-blue-dudaris">
                  NOSSOS LINKS
                </h2>
